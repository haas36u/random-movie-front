            ...
            if(isAuthenticated()) {
                ...
                return (
                    <span className="movie-actions-container">
                        ...
                        <Button icon onClick={(e) => this.props.openCollectionModal(e, this.props.movie)} tooltipLabel="Ajouter à une collection"><i className={pinClass}  id={'js-pin-' + this.props.movie.id}></i></Button>
                    </span>
                )
            }
        }
