...
export default class Cgu extends Component {
  ...
  render() {
    ...
    return (
        <div id="cgu" className="container">
            ...
            <ul>
                <li>Liste de films</li>
                <li>Recherche par le biais de filtre de films</li>
                <li>Fiche complète d'un film en particulier</li>
            </ul>
            ...
            <h6>ARTICLE 4 : Propriété intellectuelle</h6>
            ...
            <h6>ARTICLE 5 : Données personnelles</h6>
            ...
            <ul>
                <li>son espace personnel
                </li>
                <li>un formulaire de contact
                </li>
            </ul>

            <h6>ARTICLE 6 : Responsabilité et force majeure</h6>
            ...
            <h6>ARTICLE 9 : Droit applicable et juridiction compétente</h6>
